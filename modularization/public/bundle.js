	...
	var Greeter = React.createClass({
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            'div',
	            null,
	            React.createElement(GreeterMessage, { name: name, message: message, city: city, department: department }),
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                'div',
	                null,
	                React.createElement('input', { type: 'text', ref: 'department', placeholder: 'Enter department' })
	            ),
	            React.createElement(
	                'div',
	                null,
